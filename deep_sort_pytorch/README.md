...
Then you can try [train.py](deep_sort_pytorch/deep/train.py) to train your own parameter and evaluate it using [test.py](deep_sort_pytorch/deep/test.py) and [evaluate.py](deep_sort_pytorch/deep/evalute.py).
![train.jpg](deep_sort_pytorch/deep/train.jpg)
